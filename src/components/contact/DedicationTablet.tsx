  ...
  return (
    <section className="section-padding relative overflow-hidden bg-cream parchment-sheen">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="reveal relative bg-white/85 backdrop-blur-sm rounded-2xl shadow-xl px-6 py-14 md:px-16 md:py-20 text-center">
          ...
          <div className="relative mx-auto max-w-2xl">
            <p className="kicker justify-center mb-8">{t.contact.tablet.dedication}</p>

            <h2 className="font-display text-navy leading-[1.35] text-[1.35rem] md:text-[1.9rem] tracking-[0.14em]">
              ...
              <span className="block mt-6 text-[0.95rem] md:text-[1.15rem] tracking-[0.2em] text-navy/70">
                <Epigraph carved="VADAKKANKULAM · 627116" plain="Vadakkankulam 627116" />
              </span>
            </h2>

            <div className="cross-rule my-9" aria-hidden="true">
            ...
            {/* The three dates that make this church what it is */}
            <div className="font-display text-[0.62rem] md:text-[0.7rem] tracking-[0.3em] text-gold-dark/85 space-y-3">
            ...
            <p
              className={`mt-10 font-serif italic text-navy/60 ${lang === "ta" ? "text-lg" : "text-xl"}`}
            >
        ...
        <address className="reveal not-italic mt-14 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-8 text-center sm:text-left">
          ...
          >
            <span className="block text-[0.6rem] font-display uppercase tracking-[0.32em] text-gold-dark mb-2">
              {ADDRESS.name}
            </span>
