      ...
      eras: [
        ...
        },
        {
          ...
          dots: [
            ...
            {
              year: `1745`,
              title: `The catechist and the nabab`,
              body: `The same year brought the church its own trial. Vadakkankulam then depended on the mission of Néman, and a brahmin led the pagan governor to demand a contribution for a temple. The catechist refused, and was tortured with the kittei — his fingers crushed between two blocks of wood until the blood sprang from the nails — while the neophytes' houses were pillaged. Fr Buttari at once sent two Christians with a letter to the nabab "on whom Vadakkankulam depended, and who honoured him with his friendship." The lord sent a commissioner with orders to protect the Christians thereafter, and the priest, Bertrand records, "found himself surrounded with respect and awe."`,
            },
            {
              year: `1749`,
            ...
            },
            {
              ...
              body: `After three years of cruel suffering, paraded on a buffalo, scourged and chained for months to a tree in the wilderness, Devasahayam was shot on 14 January 1752 at the Travancore lines by the Aralvaimozhi gap, dying with the names of Jesus and Mary on his lips. His body was gathered into the church of St Francis Xavier at Kottar, where — Bertrand records — the Bishop of Cochin had the Te Deum sung and himself preached the martyr's panegyric. The old accounts do not name the hill; Kattadimalai is the name it carries from the national shrine that stands there now. Of the relics kept at Vadakkankulam, the Jesuit historian Auguste Jean wrote in 1894 that the church held a part of his garment and the chains with which he was bound; the diocese records that the head-cloth he wore is kept here too. His wife, baptised Gnanapoo Theresa, lies buried in the parish cemetery.`,
            },
            {
              year: `1773–1775`,
