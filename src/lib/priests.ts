...
export const PERIODS: Period[] = [
  {
    ...
    priests: [
      ...
      },
      {
        ...
        plate: "அந்தோனிநாதர்",
        life:
          "A first-person letter of his survives, written as resident of this village the year before he held it, and it is the earliest inside view of Vadakkankulam in the whole documentary record. It was to him, on 28 October 1714, that Constantine Beschi — Veeramamunivar — made his profession of four vows; the letter Beschi wrote about it names the day and names Brandolini, and gives no place at all. He was sent to Rome in 1720 to argue the Jesuits' case in the Malabar Rites controversy, where his own brother, a cardinal, lobbied on his behalf.",
