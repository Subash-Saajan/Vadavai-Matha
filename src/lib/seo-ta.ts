...
export const ROUTES_TA: Partial<Record<RouteKey, RouteCopy>> = {
  ...
  history: {
    // "vadakkankulam church history in tamil" is a LIVE Search Console query
    // (10 impressions, position 2.4) and this title carried neither the village
    // nor a church head-noun — வடக்கன்குளம் appeared only mid-description. The
    // English twin was corrected the same way. Terms are the glossary's own:
    // village வடக்கன்குளம், Church (bldg) ஆலயம், fond title வடவை மாதா.
    title: "வடக்கன்குளம் ஆலய வரலாறு — வடவை மாதா",
  ...
  massTimings: {
    ...
    description:
      "வடக்கன்குளம் திருக்குடும்பத் திருத்தலத்தின் தினசரி, ஞாயிறு திருப்பலி நேரங்கள்; ஆண்டின் திருவிழாக்கள் — ஆகஸ்ட் 6–15 விண்ணேற்பு மாதா திருவிழா; ஆகஸ்ட் 14 இரவு 11:00 மணிக்குத் தேர் புறப்பாடு.",
  ...
  priests: {
    ...
    description:
      "1697-ல் அருட்தந்தை பெர்னார்ட் தெ சா முதல் இன்று வரை — வடக்கன்குளம் திருக்குடும்பத் திருத்தலத்தின் 69 பங்குத் தந்தையர் முழுப் பட்டியல்; மதுரைப் பணிக்களத்து இயேசு சபையினர் உட்பட.",
    crumb: "அருட்தந்தையர்",
  },
  // "வடக்கன்குளம் ஆலயம் படங்கள்" / "வடவை மாதா படம்" is what a Tamil reader types
  // for this page, so the head-noun புகைப்படங்கள் leads and the village follows.
  // The template appends · சின்ன ரோமாபுரி, so the title must not repeat it.
  gallery: {
    title: "வடக்கன்குளம் ஆலயப் புகைப்படங்கள்",
    fullTitle: "வடவை மாதா புகைப்படங்கள் — ஆலயம், திருவிழா, ஊர்",
    description:
      "வடக்கன்குளம் திருக்குடும்பத் திருத்தலம் புகைப்படங்களில்: இரட்டைக் கோபுர முகப்பு, இரட்டை மண்டபமும் பொன் பலிபீடமும், வடவை மாதாவின் திருவுருவம், ஆகஸ்ட் திருவிழாத் தேர், ஊரின் பிற ஆலயங்கள், 1901-இல் பாரிஸில் அச்சான மிகப் பழைய படம்.",
    crumb: "புகைப்படங்கள்",
  },
  sources: {
