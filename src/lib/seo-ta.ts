...
export const ROUTES_TA: Partial<Record<RouteKey, RouteCopy>> = {
  ...
  massTimings: {
    ...
    description:
      "வடக்கன்குளம் திருக்குடும்பத் திருத்தலத்தின் தினசரி, ஞாயிறு திருப்பலி நேரங்கள்; ஆண்டின் திருவிழாக்கள் — ஆகஸ்ட் 6–15 விண்ணேற்பு மாதா திருவிழா, ஆகஸ்ட் 15 தேர் ஊர்வலம்.",
