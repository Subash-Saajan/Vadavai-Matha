...
export const HISTORY_CITATIONS: Record<string, DotCitation[]> = {
  ...
  "first-inland-parish": [
    ...
    // 5  (28 October 1714 — Beschi's profession; NEW MOMENT 7 Aug 2026)
    {
      tier: "documented",
      photo: "first-inland-parish-3.jpg",
      keys: ["besse_beschi_1918", "bertrand_1847", "trento_2022"],
      note: "New moment, 7 Aug 2026. READ THE TIER NARROWLY. Documented here covers the ceremony, its date, and the priest who received it — NOT the room it happened in. Beschi made his profession of four vows on 28 October 1714 to Fr Antonius Brandolini, priest of this church, and that rests on Beschi's own letter of 12 January 1715 surviving in two independent translations of the same Latin original made seventy-one years apart: Bertrand (vol. IV, p.353, 1847) — \"le jour consacré à la mémoire des apôtres saint Simon et saint Jude. C'est le P. Ant. Brandolini, mon plus proche confrère de mission, qui a reçu mes vœux\" — and Besse (1918, p.42), to \"Father Broglias Antony Brandolini, his neighbour in the district of Vadakenkulam\". Two translators, a lifetime apart, on the mission's own documents. That is as well attested as anything on this page. THE VENUE IS NOT DOCUMENTED AND THE PROSE MUST NEVER SAY IT IS. The letter names NO PLACE — neither translation has one — so the venue cannot be read off it by anybody, and every attribution of one, ours included, is inference rather than testimony. Besse states the position himself: \"we are not told, whether at Gurukelpatti itself, or at Vadakenkulam.\" Two candidates; Vadakkankulam is the only one carrying a recorded tradition, printed in his own footnote: \"According to a local tradition Fr. Beschi took his last vows at Vadakenkulam. On the occasion of his visit he would have taken there a catechist of the caste of Rajahs.\" KB file 21, mismatch G26, is standing law on this: \"Never state the profession here as fact.\" HOW THE PROSE OBEYS THAT WHILE STILL READING AS A STORY — check this if you edit the dot. Every clause of the body is documented AS WRITTEN. The venue appears once, in the words \"Vadakkankulam has said ever since that it was done here\" — a sentence about what the village says, not about what happened, and the saying itself is documented, in print, by the Mission's own Superior in 1918. If a future edit turns that into \"it was done here\", the tier is a lie and must go back to tradition the same day. ⚠⚠ THE VENUE QUESTION WAS REOPENED ON 7 AUG 2026 AND ANSWERED AGAINST US — read this before writing anything else about it. This note first carried six reasons for concluding the ceremony happened at Vadakkankulam. Building the reference leaf for the Trento chip meant reading Trento's actual page, and it does not say what KB file 21 (G26) reports it as saying. She does NOT place the profession at Kamanayakkanpatti and does NOT infer a venue from the 12 Jan 1715 dateline. Her footnote 32 reads, verbatim: \"The official records of the vows taken by Beschi in Kurukkaḷpaṭṭi in front of Brandolini on 28/10/1714 (the fourth vow of obedience to the Pope with regard to missions, and the five simple vows) are in arsi, Lus. 13, ff. 293–294.\" Kurukkaḷpaṭṭi is Besse's Gurukelpatti — the OTHER of his two candidates. So the document this note used to call for, the registered act itself, exists, carries a shelfmark, and has been read by a scholar: it names Gurukelpatti. THE CONSEQUENCES, plainly. (1) The venue is no longer unknown. It is attested, and not in our favour. Besse's \"we are not told\" was true of the mission's narrative sources in 1918; it was never true of the Roman profession register. (2) THE SIX-REASON CASE FOR VADAKKANKULAM IS WITHDRAWN and must not be reinstated from memory. Every one of those arguments was an inference from silence, and the silence has ended. (3) NOTHING IN THE PROSE NEEDS TO CHANGE, which is the entire return on having written it carefully. The dot never asserted the venue, and its one venue sentence — \"Vadakkankulam has said ever since that it was done here\" — is a statement about what the village says, which is exactly as true today as it was yesterday and is still documented by Besse's own footnote. (4) THE TIER STAYS documented AND IS BETTER FOUNDED THAN BEFORE: ARSI Lus. 13 independently corroborates the ceremony, its date and Brandolini as the receiving priest, which is all the tier ever covered. THE CAVEAT, and it is real: we hold Trento's CITATION of ARSI Lus. 13 ff. 293–294, not the folios. Nobody on this project has seen them. A scholar citing a shelfmark for a registered act is a different order of evidence from a village tradition, but it is still one step removed, and the acquisition to make is now that specific folio rather than the vague \"look in Rome\" this note used to recommend. KB FILE 21 G26 IS WRONG AND NEEDS CORRECTING AT SOURCE: it records Trento's venue as Kamanayakkanpatti reached by dateline-inference, and on that basis withdrew an earlier demotion of the parish claim. Both halves fail against her actual footnote. The register entry should read: venue attested at Gurukelpatti by ARSI Lus. 13 ff. 293–294 as cited in Trento 2022; Vadakkankulam retains a printed local tradition (Besse 1918 p.42 n.1) and nothing beyond it. ONE THING BESSE GIVES THAT SURVIVES ALL OF THIS, and it points the same way: at p.42 he writes that it was \"during his stay at Gurukelpatti\" that Beschi received the permission from Rome — so Beschi was resident there at the time, which fits the register. TRENTO IS THEREFORE CHIPPED AS THE OPPOSING EVIDENCE, NOT AS SUPPORT, and a reader who follows the chip should meet it head on. KEEP THE EVIDENTIARY LAYERS DISTINCT: the words \"in the district of Vadakenkulam\" are Besse's own editorial identification as Mission Superior — corroborated by Caldwell and by Brandolini's letter, but NOT present in Beschi's text, which says only \"my nearest confrère in the mission\". THE ARREST NARRATIVE WAS CUT FROM THIS DOT ON 7 AUG 2026, BY THE PARISH'S DECISION, AND MUST NOT BE PUT BACK WITHOUT ASKING. An earlier draft closed on the impostor who came to this church two months later and set in motion Beschi's arrest and death sentence of 21 December 1714 — documented at Besse pp.49–53 from Brandolini's own first-person letter, and in Bertrand IV pp.345–346. It is good material and it genuinely begins here, but it is the parish's page and the parish did not want it. The dot now closes instead on the annual letter of 1715, which reports that Beschi \"gave himself entirely to the study of Tamil poetry\" and in a few months went further in it \"than any other missionary since the foundation of the Mission\", because in this country nothing is esteemed more — quoted from Trento's translation, and a better ending anyway, since it is about the poet rather than about a swindler. THE CORROBORATION STANDS EVEN THOUGH ITS SENTENCE IS GONE, and it is the reason the tradition is worth printing at all: the tradition's incidental detail — that Beschi brought his own catechist — is independently true of this village in that very year, from a primary document the tradition does not descend from. Brandolini's letter, written from \"the residence of Vadakenkulam where I then was\", has a catechist of his own household here in 1714. The two are not the same man, so it corroborates a circumstance and not the venue — but a tradition that gets a checkable circumstance right is a tradition with a memory behind it. Keep this in mind before ever demoting the tradition to a legend. NOT CHIPPED, flagged instead: the Thembavani is general Tamil literary fact and no source here is cited for it; and Purnalingam Pillai's Primer of Tamil Literature (1904), which places Beschi \"at Vadakankulam and Kamaya-Nayakanpatti between 1714–6\" and would push our way, is deliberately absent — a secondary literary handbook, not in the bibliography, and the dot does not need it. ⚠ SEPARATE, PRE-EXISTING: dot 4's prose says the impostor was \"found out by the catechist walking at his side\", but Besse p.49 and Bertrand pp.345–346 both say he DECEIVED the catechist. Dot 4's own note already says \"deceiving\". Worth fixing there. PHOTO: reuses the 1714 painting as a placeholder; a dedicated image for this moment is still to be made.",
    },
  ],
